...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupRecyclerView() {
        ...
        adapter.onEditClick = { compte ->
            ...
            Toast.makeText(
                this,
                "Modification du compte ${compte.id}",
                Toast.LENGTH_SHORT
            ).show()
        }
    }
    ...
    private fun showAddCompteDialog() {
        val dialogView = layoutInflater.inflate(R.layout.popup_compte, null)
        ...
        MaterialAlertDialogBuilder(this)
            ...
            .setPositiveButton("Ajouter") { _, _ ->
                ...
                if (solde <= 0) {
                    Toast.makeText(this, "Le solde doit être positif", Toast.LENGTH_SHORT).show()
